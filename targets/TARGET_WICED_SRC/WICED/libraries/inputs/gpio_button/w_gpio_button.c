...
{
    wiced_gpio_IRQHandler_trigger_t trigger;
    ...
    return wiced_gpio_input_IRQHandler_enable( button->gpio, trigger, gpio_button_interrupt_handler, (void*)button );
}
...
wiced_result_t gpio_button_disable( const gpio_button_t* button )
{
    ...
    return wiced_gpio_input_IRQHandler_disable( button->gpio );
}
