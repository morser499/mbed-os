...
#include "w_platform.h" /* This file is unique for each platform */
...
typedef platform_gpio_IRQHandler_trigger_t             wiced_gpio_IRQHandler_trigger_t;       /**< GPIO IRQ trigger       */

typedef platform_gpio_IRQHandler_callback_t            wiced_gpio_IRQHandler_handler_t;       /**< GPIO IRQ callback      */
 ...
 *      wiced_gpio_input_IRQHandler_enable()
 *      wiced_gpio_input_IRQHandler_disable()
 *
 ...
 * using @ref wiced_gpio_input_IRQHandler_enable is undefined.
 *
