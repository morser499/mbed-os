 ...
 *  Currently there is no WICED API which is called from an ISR, there is a low level API wwd_thread_notify_IRQHandler( )
 ...
 *  platform_gpio_IRQHandler_enable( ) or PLATFORM_MAP_ISR() for 4390x
 *
 *  @{
 */
/*****************************************************************************/
