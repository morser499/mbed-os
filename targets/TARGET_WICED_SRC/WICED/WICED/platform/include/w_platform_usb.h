...
typedef void (*platform_usb_host_IRQHandler_handler_t)( void );

/* USB20 Device interrupt handler */
typedef void (*platform_usb_device_IRQHandler_handler_t)( void );
...
typedef struct
{
    ...
    uint32_t                                    usb_host_hci_IRQHandler_number;
...
typedef struct
{
    ...
    uint32_t                                    usb_device_dci_IRQHandler_number;
...
/* USB20 Host init IRQ */
platform_result_t   platform_usb_host_init_IRQHandler( platform_usb_host_IRQHandler_handler_t irq_handler );

platform_result_t   platform_usb_host_enable_IRQHandler( void );
platform_result_t   platform_usb_host_disable_IRQHandler( void );
...
platform_result_t   platform_usb_device_init_IRQHandler( platform_usb_device_IRQHandler_handler_t irq_handler );

platform_result_t   platform_usb_device_enable_IRQHandler( void );
platform_result_t   platform_usb_device_disable_IRQHandler( void );
