...
#pragma once
#include "stdint.h"
#include "w_platform_mcu_peripheral.h" /* Include MCU-specific types */
...
} platform_gpio_IRQHandler_trigger_t;
 ...
 */
typedef void (*platform_gpio_IRQHandler_callback_t)( void* arg );      /**< GPIO interrupt callback handler */
