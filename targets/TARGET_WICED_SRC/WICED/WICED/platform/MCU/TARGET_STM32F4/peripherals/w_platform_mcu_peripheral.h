...
void              platform_uart_IRQHandler                   ( platform_uart_driver_t* driver );
void              platform_uart_tx_dma_IRQHandler            ( platform_uart_driver_t* driver );
void              platform_uart_rx_dma_IRQHandler            ( platform_uart_driver_t* driver );

void              platform_i2s_IRQHandler                    ( uint32_t i2s );
void              platform_i2s_tx_dma_IRQHandler             ( uint32_t i2s );
