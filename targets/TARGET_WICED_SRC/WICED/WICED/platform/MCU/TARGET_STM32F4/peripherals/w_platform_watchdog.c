...
#include "w_platform_config.h" /* For CPU_CLOCK_HZ */
 ...
 * By default we use TIM7 however on STM32F401 and STM32F411  and the STM32F412 platforms we use TIM4 */
    ...
    #define DBG_WATCHDOG_STM32_TIMER_IRQ           TIM7_IRQHandler
#else
    ...
    #define DBG_WATCHDOG_STM32_TIMER_IRQ           TIM4_IRQHandler
#endif
#endif
...
PLATFORM_DEFINE_ISR( dbg_watchdog_IRQHandler )
{
...
PLATFORM_MAP_ISR( dbg_watchdog_IRQHandler, DBG_WATCHDOG_STM32_TIMER_IRQ )
