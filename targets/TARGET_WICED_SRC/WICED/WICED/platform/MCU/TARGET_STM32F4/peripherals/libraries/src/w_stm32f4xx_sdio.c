...
@verbatim
 ...
 [..]
   ...
   (#) Enable the Power ON State using the w_SDIO_SetPowerState(SDIO_PowerState_ON) 
       function.
                
   (#) Enable the clock using the w_SDIO_ClockCmd() function.
  
   (#) Enable the NVIC and the corresponding interrupt using the function 
       w_SDIO_ITConfig() if you need to use interrupt mode. 
  
   (#) When using the DMA mode 
       (++) Configure the DMA using DMA_Init() function
       (++) Active the needed channel Request using w_SDIO_DMACmd() function
  
   (#) Enable the DMA using the DMA_Cmd() function, when using DMA mode. 
  
   (#) To control the CPSM (Command Path State Machine) and send 
       commands to the card use the w_SDIO_SendCommand(), 
       w_SDIO_GetCommandResponse() and w_SDIO_GetResponse() functions. First, user has
       ...
       -@@- To check if the command is well received, read the SDIO_CMDRESP
           register using the w_SDIO_GetCommandResponse().
           The SDIO responses registers (SDIO_RESP1 to SDIO_RESP2), use the
           w_SDIO_GetResponse() function.
  
   (#) To control the DPSM (Data Path State Machine) and send/receive 
       data to/from the card use the w_SDIO_DataConfig(), w_SDIO_GetDataCounter(), 
       w_SDIO_ReadData(), w_SDIO_WriteData() and w_SDIO_GetFIFOCount() functions.
...
/**
  ...
  * @retval None
  */
void w_SDIO_Init(SDIO_InitTypeDef* SDIO_InitStruct)
{
  uint32_t tmpreg = 0;
...
/**
  ...
  * @retval None
  */
void w_SDIO_StructInit(SDIO_InitTypeDef* SDIO_InitStruct)
{
...
/**
  ...
  * @retval None
  */
void w_SDIO_ClockCmd(FunctionalState NewState)
{
  /* Check the parameters */
...
/**
  ...
  * @retval None
  */
void w_SDIO_SetPowerState(uint32_t SDIO_PowerState)
{
  /* Check the parameters */
...
/**
  ...
  *            - 0x03: Power ON 
  */
uint32_t w_SDIO_GetPowerState(void)
{
...
/**
  ...
  * @retval None
  */
void w_SDIO_SendCommand(SDIO_CmdInitTypeDef *SDIO_CmdInitStruct)
{
  uint32_t tmpreg = 0;
...
/**
  ...
  * @retval None
  */
void w_SDIO_CmdStructInit(SDIO_CmdInitTypeDef* SDIO_CmdInitStruct)
{
...
/**
  ...
  */
uint8_t w_SDIO_GetCommandResponse(void)
{
...
/**
  ...
  */
uint32_t w_SDIO_GetResponse(uint32_t SDIO_RESP)
{
  __IO uint32_t tmp = 0;
...
/**
  ...
  * @retval None
  */
void w_SDIO_DataConfig(SDIO_DataInitTypeDef* SDIO_DataInitStruct)
{
  uint32_t tmpreg = 0;
...
/**
  ...
  * @retval None
  */
void w_SDIO_DataStructInit(SDIO_DataInitTypeDef* SDIO_DataInitStruct)
{
...
/**
  ...
  */
uint32_t w_SDIO_GetDataCounter(void)
{ 
  return SDIO->DCOUNT;
}
...
/**
  ...
  * @retval None
  */
void w_SDIO_WriteData(uint32_t Data)
{ 
  SDIO->FIFO = Data;
}
...
/**
  ...
  */
uint32_t w_SDIO_GetFIFOCount(void)
{ 
  return SDIO->FIFOCNT;
}
...
/**
  ...
  * @retval None
  */
void w_SDIO_StartSDIOReadWait(FunctionalState NewState)
{ 
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None
  */
void w_SDIO_StopSDIOReadWait(FunctionalState NewState)
{ 
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None
  */
void w_SDIO_SetSDIOReadWaitMode(uint32_t SDIO_ReadWaitMode)
{
  /* Check the parameters */
...
/**
  ...
  * @retval None
  */
void w_SDIO_SetSDIOOperation(FunctionalState NewState)
{ 
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None
  */
void w_SDIO_SendSDIOSuspendCmd(FunctionalState NewState)
{ 
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None
  */
void w_SDIO_CommandCompletionCmd(FunctionalState NewState)
{ 
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None
  */
void w_SDIO_CEATAITCmd(FunctionalState NewState)
{ 
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None
  */
void w_SDIO_SendCEATACmd(FunctionalState NewState)
{ 
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None
  */
void w_SDIO_DMACmd(FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None 
  */
void w_SDIO_ITConfig(uint32_t SDIO_IT, FunctionalState NewState)
{
  /* Check the parameters */
...
/**
  ...
  */
FlagStatus w_SDIO_GetFlagStatus(uint32_t SDIO_FLAG)
{ 
...
/**
  ...
  * @retval None
  */
void w_SDIO_ClearFlag(uint32_t SDIO_FLAG)
{ 
  /* Check the parameters */
...
/**
  ...
  */
ITStatus w_SDIO_GetITStatus(uint32_t SDIO_IT)
{ 
...
/**
  ...
  * @retval None
  */
void w_SDIO_ClearITPendingBit(uint32_t SDIO_IT)
{ 
  /* Check the parameters */
